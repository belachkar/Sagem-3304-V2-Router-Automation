...
{
  var tmp;
  document.form_contents.elements['md5_pass'].value=document.form_contents.elements['password_906442758'].value+document.form_contents.elements['auth_key'].value;
  tmp=hex_md5(document.form_contents.elements['md5_pass'].value);
  document.form_contents.elements['md5_pass'].value=tmp;
  document.form_contents.elements['password_906442758'].value='';
...
function mimic_button(button_name, cgi)
{
  if (is_submit)
    return;
  is_submit=1;
  let f=document.form_contents;
  switch(cgi) {
  case 0:
    f.encoding='application/x-www-form-urlencoded';
    f.action='/cache/1105835773/index.cgi';
    break;
  case 2:
    f.encoding='multipart/form-data';
    f.action='/cache/968085752/index.cgi';
    break;
  }
...
function lb_mimic_button(button_name, cgi, buttName)
{
  ...
  case 0:
    f.encoding='application/x-www-form-urlencoded';
    f.action='/cache/1367931775/index.cgi';
    break;
  case 2:
    f.encoding='multipart/form-data';
    f.action='/cache/130306077/index.cgi';
    break;
  }
  f.mimic_button_field.value = button_name;
  setTimeout('is_submit=0', 1000);
