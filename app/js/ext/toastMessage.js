...
!(function() {
  ...
  //-------------------------------------------------------------------------------------------------------------------------------------------------//
  var template =
    '<div class="outerLayer" style="{{outerStyle}}"><div class="innerLayer" style="{{innerStyle}}">{{message}}</div></div>';
  var errorMessage =
    'Some Error Occured while appending Template Message. If the error is due to some error in the Plugin iteself please raise an Issue on Github.';
  var errorMessageStyles =
    'Some Error Occured while applying Styles. Please check the styles object Passed. If the error is due to some error in the Plugin iteself please raise an Issue on Github.';
  ...
  var appendMessage = function(messageHtml, messageTime, messageStyles) {
    try {
      ...
      messageWrapper.style.fontSize = '1.2em';
      messageWrapper.style.top = '7vh';
      messageWrapper.style.right = '7vh';
      // messageWrapper.style.zIndex = '200';
      messageWrapper.style['text-align'] = 'center';
      messageWrapper.style.width = '40vw';
  ...
  var mergeStyles = function(style1, style2) {
    if (showWarnings) {
      if (console.warn) {
        console.warn(
          'Toast Messages: You have passed a style Object.\n',
